...
// CapricEngine - Music Data Config - Version 1.27.0 (Time Signature Update)
...
async function loadSongStructures() {
    try {
        ...
        SONG_STRUCTURE_TEMPLATES = await resp.json();
    } catch (e) {
...
function getSongStructure(templateId) {
    if (!SONG_STRUCTURE_TEMPLATES || Object.keys(SONG_STRUCTURE_TEMPLATES).length === 0) return null;
    if (templateId && SONG_STRUCTURE_TEMPLATES[templateId]) {
        return SONG_STRUCTURE_TEMPLATES[templateId];
    }
    const ids = Object.keys(SONG_STRUCTURE_TEMPLATES);
    if(ids.length === 0) return null;
    const randKey = ids[Math.floor(Math.random() * ids.length)];
    return SONG_STRUCTURE_TEMPLATES[randKey];
}

loadSongStructures();

const MOOD_SONG_STRUCTURES = {
    "very_normal_person": [
        ["Intro", "Verse", "Chorus", "Verse", "Chorus", "Bridge", "Chorus"],
        ["Verse", "Chorus", "Verse", "Chorus", "Middle 8", "Chorus", "Outro"],
        ["Intro", "Verse", "Verse", "Chorus", "Chorus", "Solo", "Chorus"],
        ["Verse", "Pre-Chorus", "Chorus", "Verse", "Pre-Chorus", "Chorus", "Outro"],
        ["Intro", "Verse", "Chorus", "Instrumental", "Verse", "Chorus", "Outro"],
        ["Verse", "Verse", "Chorus", "Verse", "Middle 8", "Chorus"],
        ["Intro", "Verse", "Chorus", "Verse", "Solo", "Chorus", "Coda"],
        ["Verse", "Chorus", "Instrumental", "Bridge", "Chorus", "Outro"],
        ["Intro", "Verse", "Chorus", "Chorus", "Middle 8", "Chorus (double)"],
        ["Verse", "Chorus", "Breakdown", "Chorus", "Outro"]
    ],
    "malinconico_introspettivo": [
        ["Intro", "Verse", "Verse", "Chorus", "Verse", "Chorus", "Outro"],
        ["Verse", "Chorus", "Verse", "Bridge", "Chorus", "Instrumental", "Chorus"],
        ["Intro", "Verse", "Chorus", "Middle 8", "Verse", "Chorus"],
        ["Verse", "Verse", "Chorus", "Instrumental", "Chorus", "Outro"],
        ["Intro", "Verse", "Pre-Chorus", "Chorus", "Verse", "Pre-Chorus", "Chorus"],
        ["Verse", "Chorus", "Verse", "Bridge", "Chorus", "Outro (quiet)"],
        ["Intro", "Verse", "Chorus", "Solo", "Chorus", "Coda"],
        ["Verse", "Chorus", "Instrumental", "Verse", "Chorus", "Refrain"],
        ["Intro", "Verse", "Verse", "Chorus", "Breakdown", "Chorus"],
        ["Verse", "Verse", "Chorus", "Middle 8", "Chorus", "Fade out"]
    ],
    "ansioso_distopico": [
        ["Intro", "Verse", "Chorus", "Breakdown", "Chorus", "Outro"],
        ["Verse", "Chorus", "Verse", "Chorus", "Noise Interlude", "Chorus"],
        ["Intro", "Verse", "Chorus", "Verse", "Chorus", "Bridge", "Chorus"],
        ["Verse", "Verse", "Chorus", "Interlude", "Breakdown", "Chorus"],
        ["Intro", "Verse", "Chorus", "Silence", "Chorus", "Outro"],
        ["Verse", "Chorus", "Verse", "Chorus", "Glitch Section", "Final Chorus"],
        ["Intro", "Verse", "Chorus", "Bridge (modulato)", "Chorus", "Outro"],
        ["Verse", "Verse", "Breakdown", "Chorus", "Outro"],
        ["Intro", "Verse", "Chorus", "Breakdown", "Instrumental", "Chorus"],
        ["Verse", "Chorus", "Noise Solo", "Chorus", "Outro"]
    ],
    "etereo_sognante": [
        ["Intro", "Verse", "Chorus", "Ambient Interlude", "Chorus", "Outro"],
        ["Verse", "Chorus", "Verse", "Chorus", "Bridge", "Chorus", "Outro"],
        ["Intro", "Verse", "Verse", "Chorus", "Solo", "Chorus", "Coda"],
        ["Verse", "Chorus", "Instrumental", "Chorus", "Refrain", "Outro"],
        ["Intro", "Verse", "Pre-Chorus", "Chorus", "Ambient Loop", "Chorus"],
        ["Verse", "Chorus", "Chorus", "Instrumental", "Bridge", "Chorus"],
        ["Intro", "Verse", "Verse", "Chorus", "Refrain", "Outro"],
        ["Verse", "Chorus", "Instrumental", "Chorus", "Fade"],
        ["Intro", "Chorus", "Verse", "Chorus", "Instrumental", "Coda"],
        ["Verse", "Verse", "Chorus", "Bridge", "Outro sospeso"]
    ],
    "arrabbiato_critico": [
        ["Intro", "Verse", "Chorus", "Verse", "Chorus", "Breakdown", "Final Chorus"],
        ["Verse", "Chorus", "Verse", "Chorus", "Bridge", "Chorus", "Scream Outro"],
        ["Intro", "Verse", "Verse", "Chorus", "Verse", "Breakdown", "Chorus"],
        ["Verse", "Chorus", "Verse", "Solo", "Chorus", "Outro"],
        ["Intro", "Verse", "Chorus", "Verse", "Bridge", "Chorus", "Slam End"],
        ["Verse", "Chorus", "Instrumental", "Verse", "Chorus", "Coda"],
        ["Intro", "Verse", "Chorus", "Breakdown", "Chorus", "Final Shout"],
        ["Verse", "Chorus", "Verse", "Chorus", "Scream Interlude", "Chorus"],
        ["Intro", "Verse", "Chorus", "Chorus", "Guitar Solo", "Chorus"],
        ["Verse", "Verse", "Chorus", "Breakdown", "Chorus", "End"]
    ],
    "sperimentale_astratto": [
        ["Intro", "Texture", "Verse", "Fragment", "Chorus", "Outro"],
        ["Verse", "Chorus", "Experimental Interlude", "Verse", "Chorus", "Coda"],
        ["Intro", "Spoken", "Verse", "Chorus", "Glitch", "Noise", "Outro"],
        ["Verse", "Fragment", "Chorus", "Soundscape", "Chorus", "Outro"],
        ["Intro", "Verse", "Chorus", "Drone Interlude", "Fragment", "Chorus"],
        ["Verse", "Interlude", "Chorus", "Fragment", "Glitch Solo", "Chorus"],
        ["Intro", "Verse", "Chorus", "Disruption", "Verse", "Chorus", "Fade"],
        ["Verse", "Chorus", "Reverse", "Glitch", "Chorus", "Outro"],
        ["Intro", "Chorus", "Fragment", "Bridge", "Chorus", "Sonic End"],
        ["Verse", "Chorus", "Sonic Interlude", "Fragment", "Outro"]
    ]
};
